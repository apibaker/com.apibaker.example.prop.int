...
http://apibaker.com/#/undefined/com.apibaker.example.prop.int
...
```
The database URL may look like as: postgresql://postgres:postgres@localhost/com.apibaker.example.prop.int.
